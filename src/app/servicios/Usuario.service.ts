...
export class UsuarioService {
  ...
  private apiUrl = 'http://localhost:8080/GestionarUsuarios/api/usuarios'; // URL del usuario api rest
  ...
  getUsuarioExterno(): Promise< Usuario[] > {
    return axios.get< Usuario[] >('http://localhost:8080/GestionarUsuarios/api/usuarios').then(response => response.data); // usuario externo cambiar
  }
